	...
	return (
		<main className="relative w-full -mt-[96px]">
			...
			<div className="w-full border-b">
				<div className="w-full max-w-7xl mx-auto py-3 px-4 lg:px-0 flex gap-4 font-poppins">
			...
			<div className="w-full max-w-7xl mx-auto px-4 lg:px-0 grid grid-cols-1 md:grid-cols-3">
