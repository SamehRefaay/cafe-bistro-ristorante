				...
				<div className='mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-10'>
					<div className='flex flex-col gap-5'>
						...
						<p className='text-base text-[#666]'>
							...
							<span className='text-[#333]'>Nulla vulputate</span> , lectus vel volutpat efficitur, orci
							lacus sodales sem, sit amet quam: <span className='text-primary-red'>(001) 345 6789</span>
						</p>
					</div>
					<div className='flex flex-col gap-5'>
						<h3 className='text-2xl font-poppins leading-7 tracking-[3px] font-medium uppercase'>
						...
						<p className='text-base text-[#666]'>
							Donec feugiat ligula rhoncus: <span className='text-primary-red'>(001) 345 6789</span> ,
